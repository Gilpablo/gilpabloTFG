...
class RopaModelo {
    ...
    public function abrirAsesoria($datos){
        ...
        // Cambiamos estado de la asesoria: 2 -- Procesando
        $this->db->query("UPDATE asesoria SET id_estado=2, fecha_fin=null
                                            WHERE id_asesoria=:id_asesoria");
    ...
    public function getAsesorias(){
        $this->db->query("SELECT * FROM asesoria NATURAL JOIN estados ORDER BY fecha_inicio DESC");
    ...
    public function delAsesoria($id_asesoria){
        $this->db->query("DELETE FROM asesoria WHERE id_asesoria = :id_asesoria");
    ...
    public function delAccion($id_reg_acciones){
        $this->db->query("DELETE FROM reg_acciones WHERE id_reg_acciones = :id_reg_acciones");
    ...
    public function getAsesoriasFiltro($datos){
